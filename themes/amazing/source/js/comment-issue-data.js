// 评论issues仓库 by.removeif https://mtaoqi.github.io/
var repoIssuesUrl = "https://api.github.com/repos/userName/userRepo/issues";
// 对应仓库 clientId、clientSecret 关于这两个参数的安全问题，查看 https://mtaoqi.github.io/2019/09/19/博客源码分享.html#1-热门推荐，最新评论：
...
function loadIssueData(appId, appKey, userName, userRepo, isValine) {
    ...
    setTimeout(function () { // 延迟1s执行，保证其余的先加载
        ...
        // console.clear();
        console.log("~~~~欢迎光临！记得有时间多来看看哦，https://mtaoqi.github.io/ ~~~~")
    }
        ,
        500
    )
